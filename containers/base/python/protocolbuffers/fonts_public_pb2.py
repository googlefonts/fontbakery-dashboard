...
FamilyProto = _reflection.GeneratedProtocolMessageType('FamilyProto', (_message.Message,), {
  ...
  'ApiDefaultOverridesEntry' : _reflection.GeneratedProtocolMessageType('ApiDefaultOverridesEntry', (_message.Message,), {
...
_FAMILYPROTO_APIDEFAULTOVERRIDESENTRY._options = None
